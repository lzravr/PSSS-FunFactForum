...
<title> <c:out value="Chat"></c:out> </title>
</head>
<body>
		...
		<div class="row">
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4"> 
		      ...
		      <div class="row">
		        ...
		        <div class="col-md-4">
			        <button type="button" id="connect" class="btn btn-outline-success chat-controll"><span class="btn-ctl" data-feather="log-in" ></span></button>
				    <button type="button" id="disconnect" class="btn btn-outline-danger chat-controll"><span class="brn-ctl" data-feather="x"></span></button>
			    </div>
			  </div>
			  <div class="row">
			  
		        <div class="col-md-8 chat-messages" id="message-board">
		        	Select the user you want to message... <br>
		        	Of course, there has to be online users...
		        	
		        </div>
		        <div class="col-md-4 chat-messages">
		        	<h6 class='pt-2'>Active users</h6>
		        	<hr>
		        	<ul id="userList">
		        ...
		        <div class="input-group mb-3 pt-4">
				  <input type="text" id="message" class="form-control" placeholder="Say hello..." aria-label="Recipient's username" aria-describedby="basic-addon2">
				  <div class="input-group-append">
				  	
				  	<input id="username" value="${user.username }" hidden disabled="disabled">
				    <input id="firstname" value="${user.name }" hidden disabled="disabled">
				    <input id="lastname" value="" hidden disabled="disabled">
				    <button id="send" class="btn btn-outline-secondary" type="button">Send</button>
				    
				  </div>
				</div>
				<label>Chat to  </label><span id="chatTo"></span>
		      </div>
		      <a href="data/DesktopChat.jar" download>Download desktop chat</a>
		      </div>
